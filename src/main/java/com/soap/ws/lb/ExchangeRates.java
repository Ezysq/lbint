 ...
 * 
 */
@WebServiceClient(name = "ExchangeRates", targetNamespace = "http://webservices.lb.lt/ExchangeRates", wsdlLocation = "https://www.lb.lt/webservices/ExchangeRates/ExchangeRates.asmx?WSDL")
public class ExchangeRates
    extends Service
{

    private static final URL EXCHANGERATES_WSDL_LOCATION;
    private static final WebServiceException EXCHANGERATES_EXCEPTION;
    private static final QName EXCHANGERATES_QNAME = new QName("http://webservices.lb.lt/ExchangeRates", "ExchangeRates");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://www.lb.lt/webservices/ExchangeRates/ExchangeRates.asmx?WSDL");
